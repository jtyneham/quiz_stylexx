import { initRandomLetter } from "./games/rngl-p5r5.js";
...
async function openTile(tile){
  ...
  if(file==="missingword.html"){
    if(!missingWordLoaded){
      const module=await import("./games/missing-word-p5r10.js");
  ...
  if(file==="missingwordpokemon.html"){
    if(!missingWordPokemonLoaded){
      const module=await import("./games/missing-word-pokemon-p5r10.js");
  ...
  if(file==="hangman1.html"){
    if(!hangmanLoaded){
      const module=await import("./games/hangman-p5r12.js?v=24");
  ...
  if(file==="hangmanpokemon.html"){
    if(!hangmanPokemonLoaded){
      const module=await import("./games/hangman-pokemon-p5r12.js?v=24");
