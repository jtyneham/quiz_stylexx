import { initRandomLetter } from "./games/rngl-p5r4.js";
...
async function openTile(tile){
  ...
  if(file==="missingword.html"){
    if(!missingWordLoaded){
      const module=await import("./games/missing-word-p5r4.js");
  ...
  if(file==="missingwordpokemon.html"){
    if(!missingWordPokemonLoaded){
      const module=await import("./games/missing-word-pokemon-p5r4.js");
  ...
  if(file==="hangman1.html"){
    if(!hangmanLoaded){
      const module=await import("./games/hangman-p5r4.js");
  ...
  if(file==="hangmanpokemon.html"){
    if(!hangmanPokemonLoaded){
      const module=await import("./games/hangman-pokemon-p5r4.js");
